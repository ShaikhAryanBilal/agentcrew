...
produces:
  ...
  - artifact: Meeting minutes (full record)
    to: .crewmarkdown/logs/<yyyy>/<MM>/<dd>/<HHmmss>/<chat-slug>-[<HHmmss>]/meeting.md
rules:
...
| Meeting minutes (full record) | `.crewmarkdown/logs/<yyyy>/<MM>/<dd>/<HHmmss>/<chat-slug>-[<HHmmss>]/meeting.md` |
