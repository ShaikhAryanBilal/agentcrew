...
quality_checklist:
  ...
  - Decision logged to `.crewmarkdown/logs/<yyyy>/<MM>/<dd>/<HHmmss>/<chat-slug>-[<HHmmss>]/debate.md` (derive `<chat-slug>` from request text)
---
...
7. Log to `.crewmarkdown/logs/<yyyy>/<MM>/<dd>/<HHmmss>/<chat-slug>-[<HHmmss>]/debate.md` (derive `<chat-slug>` from request text)
