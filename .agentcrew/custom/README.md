...
2. If file has content â†’ inject as additional context
3. If file is empty / default â†’ skip, use standard procedure
...
./.agentcrew/scripts/init-workflow.sh

# Or non-interactive:
./.agentcrew/scripts/init-workflow.sh --project "MyApp" --stack "node,react" --ci "GitHub Actions"
```
